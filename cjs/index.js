  ...
  function runAllEffect(effects, effectId, cb) {
    ...
    function checkEffectEnd() {
      if (completedCount === keys.length) {
        completed = true;
        cb(is.array(effects) ? array.from(_extends$3({}, results, { length: keys.length })) : results);
      }
    }
    ...
    keys.forEach(function (key) {
      var chCbAtKey = function chCbAtKey(res, isErr) {
        ...
        if (isErr) {
          ...
          cb(is.array(effects) ? [].slice.call(_extends$3({}, response, { length: keys.length })) : response);
        }
      };
      chCbAtKey.cancel = noop;
      childCbs[key] = chCbAtKey;
...
var addNameSpace = function addNameSpace() {
    ...
    return Object.entries(obj).reduce(function (r, _ref) {
        ...
        return _extends$4({}, r, defineProperty({}, namespace + '/' + n, m));
    }, {});
};
...
function registerModel(store, sagaMiddleware, models) {
    var deal = (Array.isArray(models) ? models : [models]).filter(function (_ref7) {
        var namespace = _ref7.namespace,
            effects$$1 = _ref7.effects,
            reducer = _ref7.reducer;

        return [namespace, effects$$1, reducer].every(function (v) {
            return !lodash.isUndefined(v);
        });
    }).reduce(function (r, _ref8) {
        var namespace = _ref8.namespace,
            effects$$1 = _ref8.effects,
            reducer = _ref8.reducer,
            state = _ref8.state;

        return {
            state: _extends$4({}, r.state || {}, defineProperty({}, namespace, state)),
            sagas: _extends$4({}, r.sagas || {}, defineProperty({}, namespace, addNameSpace(effects$$1, namespace))),
            reducers: _extends$4({}, r.reducers || {}, defineProperty({}, namespace, addNameSpace(reducer, namespace)))
        };
    }, {});
    ...
    injectAsyncSagas(store, Object.entries(deal.sagas).reduce(function (r, _ref9) {
        ...
        return _extends$4({}, r, defineProperty({}, name, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                                ...
                                return regeneratorRuntime.wrap(function _callee$(_context) {
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            case 0:
                                                _context.next = 2;
                                                return Object.entries(fns).map(function (_ref11) {
...
var AsyncComponent = (function (registerModel, fn) {
    ...
    var isMore = (typeof fn === 'undefined' ? 'undefined' : _typeof$3(fn)) === 'object';

    return (!isMore ? Loadable : Loadable.Map)(_extends$4({
        loader: fn,
        ...
        render: function render(_ref, props) {
            ...
            return React.createElement(ReturnCompoment, _extends$4({}, props2, props));
        }
    }, reset));
});
...
function configureStore(params2) {
    // const {
    //     initialState = {},
    //     reducers = {},
    //     sagas = [],
    ...
    var sagas = params.sagas || [];
    var middlewares = params.middlewares || [];
    // 中间件列表
    var middleware = [historyMiddleware, sagaMiddleware, axiosMiddleware].concat(toConsumableArray(params.middlewares || []));

    var store = createStore(combineReducers(_extends$4({}, reducers, {
            ...
            createClass(HOCComponent2, [{
                ...
                value: function render() {
                    return React.createElement(
                        ...
                        {
                            value: _extends$4({}, lodash.pick(this.props, transferKey), this.props.CONTEXT || {}, cust)
                        },
                        React.createElement(WrappedComponent, lodash.omit(this.props, [].concat(toConsumableArray(transferKey), ['CONTEXT'])))
                    );
                }
            }]);
...
var XRProvider = function XRProvider(props) {
    return React.createElement(reactRedux.Provider, props);
};

var XRProvider$1 = TransferContext(3, ['XR'])(XRProvider);
...
var ExtendsContext = (function (type) {
            ...
            createClass(HOCComponent, [{
                ...
                value: function render() {
                    ...
                    return React.createElement(
                        ...
                        null,
                        function (context) {
                            var newProps = _extends$4({}, _this2.props, {
                                CONTEXT: _extends$4({}, lodash.isEmpty(limit) ? context : lodash.pick(context, limit))
                            });
    ...
    return function (WrappedComponent) {
        return function (_React$Component) {
            ...
            createClass(A, [{
                key: 'render',
                value: function render() {
                    return React.createElement(WrappedComponent, _extends$4({
                        store: store,
                        XR: { registerModel: registerModel, AsyncComponent: AsyncComponent }
                    }, this.props));
                }
            }]);
            return A;
...
var init = function init() {
    return {
        Provider: aa(configureStore())(XRProvider$1)
        // ExtendsContext
    };
};
...
exports.ExtendsContext = ExtendsContext;
