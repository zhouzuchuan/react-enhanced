...
var redux__default = _interopDefault(redux);
...
function injectAsyncReducers(store, asyncReducers, initialState) {
    ...
    if (asyncReducers) {
        ...
        flag && store.replaceReducer(redux.combineReducers(store.asyncReducers));
    }
}
...
function registerModel(store, sagaMiddleware, models) {
    var deal = (Array.isArray(models) ? models : [models]).filter(function (_ref7) {
        ...
        return {
            ...
            sagas: _extends$3({}, r.sagas || {}, defineProperty({}, namespace, addNameSpace(effects$$1, namespace))),
            reducers: _extends$3({}, r.reducers || {}, defineProperty({}, namespace, addNameSpace(reducer, namespace)))
        };
    }, {});
...
function configureStore(params2) {
    ...
    var store = redux.createStore(redux.combineReducers(_extends$3({}, reducers, {
        route: reactRouterRedux.routerReducer
    })), initialState, reduxDevtoolsExtension_1(redux.applyMiddleware.apply(undefined, toConsumableArray(middleware))));
            ...
            createClass(HOCComponent2, [{
                ...
                value: function render() {
                    return React.createElement(
                        ...
                        {
                            value: _extends$3({}, lodash.pick(this.props, transferKey), this.props.CONTEXT || {}, cust)
                        },
            ...
            createClass(HOCComponent, [{
                ...
                value: function render() {
                    ...
                    return React.createElement(
                        ...
                        null,
                        function (context) {
                            var newProps = _extends$3({}, _this2.props, {
                                CONTEXT: _extends$3({}, lodash.isEmpty(limit) ? context : lodash.pick(context, limit))
                            });
