 ...
 * 封装 antd Modal HOC
 * */
var createModal = (function (_ref) {
    var _ref$okTrigger = _ref.okTrigger,
        okTrigger = _ref$okTrigger === undefined ? '' : _ref$okTrigger,
        _ref$cancelTrigger = _ref.cancelTrigger,
        cancelTrigger = _ref$cancelTrigger === undefined ? '' : _ref$cancelTrigger,
        _ref$createAndshowAft = _ref.createAndshowAfter,
        createAndshowAfter = _ref$createAndshowAft === undefined ? '' : _ref$createAndshowAft,
        modal = _ref.modal,
    ...
    return function (WrappedComponent) {
        ...
        return function (_React$Component) {
            inherits(CreateModalHoc, _React$Component);

            function CreateModalHoc() {
                var _ref2;

                var _temp, _this, _ret;

                classCallCheck(this, CreateModalHoc);

                for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                    args[_key] = arguments[_key];
                }

                return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref2 = CreateModalHoc.__proto__ || Object.getPrototypeOf(CreateModalHoc)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
                    visible: false,
                    prevCount: null,
                    confirmLoading: false,
                    modalProps: {}
                }, _this.componentRef = ref, _this.closeModal = function () {
                    _this.setState({
                        visible: false,
                        confirmLoading: false,
                        modalProps: {}
                    ...
                    _this.dispatchAction(cancelTrigger, _this.closeModal);
                }, _this.handleOk = function () {
                    _this.setState({
                        confirmLoading: true
                    });
                    _this.dispatchAction(okTrigger, _this.closeModal, function () {
                        _this.setState({
                            confirmLoading: false
                        });
                    });
                }, _this.dispatchAction = function (name) {
                    var fn = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (f) {
                        return f;
                    };
                    var fn2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (f) {
                        return f;
                    };

                    var currRef = _this.componentRef.current;

                    if (name !== '' && isFunction(currRef[name])) {
                        return new Promise(currRef[name]()).then(isFunction(fn) ? fn : function (f) {
                            return f;
                        }).catch(fn2);
                    } else {
                        return Promise.resolve().then(isFunction(fn) ? fn : function (f) {
                            return f;
                        }).catch(fn2);
                    }
                }, _this.modalControlState = function (params) {
                    _this.setState(params);
                }, _temp), possibleConstructorReturn(_this, _ret);
            }

            createClass(CreateModalHoc, [{
                key: 'render',
                value: function render() {
                    var _state = this.state,
                        visible = _state.visible,
                        confirmLoading = _state.confirmLoading,
                        prevCount = _state.prevCount,
                        modalProps = _state.modalProps;
                    var _props = this.props,
                        _props$modal = _props.modal,
                        propsModal = _props$modal === undefined ? {} : _props$modal,
                        count = _props.count,
                        props = objectWithoutProperties(_props, ['modal', 'count']);


                    var createModalProps = _extends({
                        maskClosable: false
                    }, modal, propsModal, {
                        visible: visible,
                    ...
                    var ownprops = control ? { modalControlState: this.modalControlState } : {};

                    return prevCount ? React__default.createElement(
                        antd.Modal,
                        createModalProps,
                        count && React__default.createElement(WrappedComponent, _extends({}, _extends({}, props, ownprops, { count: count, loading: confirmLoading }), {
                ...
                value: function getDerivedStateFromProps(np, ps) {
                    if (np.count !== ps.prevCount) {
                        if (ref.current) {
                            var fn = ref.current[createAndshowAfter];
                            if (isFunction(fn)) {
                                fn();
                            }
                        }
...
var Loading = reactRedux.connect(function (store) {
    ...
    createClass(Loading, [{
        ...
        value: function render() {
            ...
            var createChldren = update ? React__default.createElement(
                WrapIn,
                null,
            ...
            var Wrap = update ? WrapLoading : WrapEmpty;
...
// 继承指定class
var extendsClass = function extendsClass(A) {
    return function (_A) {
        inherits(_class, _A);
...
var RcRoute = function (_React$Component) {
    inherits(RcRoute, _React$Component);
    ...
    function RcRoute() {
        ...
        classCallCheck(this, RcRoute);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this2 = possibleConstructorReturn(this, (_ref = RcRoute.__proto__ || Object.getPrototypeOf(RcRoute)).call.apply(_ref, [this].concat(args))), _this2), _this2.componentRender = function (mothed) {
            for (var _len2 = arguments.length, params = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
                params[_key2 - 1] = arguments[_key2];
            }

            if (RE.guardFunction && !RE.guardFunction.apply(RE, params)) {
                return null;
            }

            if (typeof mothed === 'function') {
                if (mothed.name === 'LoadableComponent') {
                    var CustComponent = extendsClass(mothed);
                    return new CustComponent();
                } else {
                    // @ts-ignore
                    return new (Function.prototype.bind.apply(mothed, [null].concat(params)))();
                }
            } else {
                return mothed;
            }
    ...
    createClass(RcRoute, [{
        ...
        value: function render() {
            ...
            return React.createElement(reactRouterDom.Route, ['component', 'render'].reduce(function (r, v) {
                return _extends({}, r, r[v] && defineProperty({}, v, function () {
                    for (var _len3 = arguments.length, a = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
                        a[_key3] = arguments[_key3];
                    }

                    return _this3.componentRender.apply(_this3, [r[v]].concat(a));
                }));
            }, this.props));
        }
    }]);
...
var ReactEnhancedProvider = function ReactEnhancedProvider(props) {
    ...
    if (RE.persistor) {
        var C = require('redux-persist/integration/react').PersistGate;
...
function configureStore() {
    ...
    var _modelRedux$create = modelRedux.create(dealmodelConfig),
        ...
        persistor = _modelRedux$create.persistor;
...
exports.hocs = index$2;
exports.middlewares = index$3;
