...
var returnUpdate = function returnUpdate(include, exclude, key) {
    if (key === '') return false;
    if (isNull(include)) {
...
var PlaceholderLoading = (function (rl) {
    var Loading = function (_React$Component) {
        ...
        createClass(Loading, [{
            ...
            value: function shouldComponentUpdate(np) {
                return np.update || !isEqual_1(np.children, this.props.children);
            }
        }, {
            key: 'render',
            value: function render() {
                ...
                if (update && loading) {
                    var component = React.createElement(
                        'div',
                        { className: className + (mask ? ' RE-LOADING-WRAP' : '') },
                        null,
                        cover ? null : rl,
                        content,
    ...
    return connect(function (store) {
        var _ref = store['@@LOADING'] || {},
            _ref$key = _ref.key,
            loadKey = _ref$key === undefined ? '' : _ref$key,
    ...
    }, null, function (_ref3, action, _ref2) {
        var loading = _ref3.loading,
            loadKey = _ref3.loadKey;
        var _ref2$include = _ref2.include,
            include = _ref2$include === undefined ? null : _ref2$include,
            _ref2$exclude = _ref2.exclude,
            exclude = _ref2$exclude === undefined ? null : _ref2$exclude,
            rest = objectWithoutProperties(_ref2, ['include', 'exclude']);
...
var loadingModel = {
    ...
    effects: {},
    reducers: {
        __SET_LOADING_START__: function __SET_LOADING_START__(state, _ref) {
        ...
        __SET_LOADING_END__: function __SET_LOADING_END__(state, _ref2) {
...
function configureStore() {
    ...
    Object.entries({
        ...
        }, _extends({}, !isEmpty(api) ? { $service: apiManage.getService() } : {})),
        _effects: {},
        _reducers: {},
        _models: [],
