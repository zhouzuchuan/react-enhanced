...
var init = (function (_ref) {
    ...
    apiManage.serviceList = Object.entries(list).reduce(function (r, _ref2) {
        ...
        return _extends$2({}, r, Object.entries(api).reduce(function (r2, _ref4) {
            var _ref5 = slicedToArray$1(_ref4, 2),
                name = _ref5[0],
                requestPath = _ref5[1];

            return _extends$2({}, r2, defineProperty$1({}, name.replace(/^api/, 'serve'), function (params, data) {
                return request(defineProperty$1({
                    method: method,
        ...
        return function (action) {
            ...
            return request().then(function (result) {
                ...
                var limitData = isString(resultLimit) ? take$1(transferData, resultLimit) : isArray$1(resultLimit) ? resultLimit.reduce(function (r, v) {
                    ...
                    return [].concat(toConsumableArray(r), [take$1(transferData, v) || []]);
                }, []) : transferData;
...
function configureStore() {
    ...
    apiManage$1.init({ list: apiList });

    Object.entries({
        __warehouse__: warehouse.reduce(function (r, v, i) {
            return _extends({}, r, defineProperty({}, v, {}));
        }, _extends({}, !lodash_isempty(apiList) && { $service: apiManage$1.getService() })),
        _effects: {},
        _reducers: {},
        _models: [],
